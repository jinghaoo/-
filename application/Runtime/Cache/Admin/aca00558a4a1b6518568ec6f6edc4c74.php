...
<!-- sidebar end -->
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">修改轮播图</strong> / <small>Banner add</small></div>
    </div>
    <hr/>
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$con): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" value="<?php echo ($con["id"]); ?>">
          <div class="am-form-group">
            <label for="user-name" class="am-u-sm-3 am-form-label">序号 / Order</label>
            <div class="am-u-sm-9">
              <input type="text" id="user-name" placeholder="" name="order" value="<?php echo ($con["orderby"]); ?>">
             
            </div>
          </div>

          <div class="am-form-group">
            <label for="user-email" class="am-u-sm-3 am-form-label">轮播图 / Pic</label>
            <div class="am-u-sm-9">
            <img src= "<?php echo (ltrim($con["ban_pic"],'.')); ?>" style="width:300px;" />
              <input type="file" id="case_pic" name="ban_pic" value="<?php echo ($con["ban_pic"]); ?>">
            </div>
          </div>
