...
<!-- sidebar end -->
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">新闻管理</strong> / <small>列表</small></div>
    </div>
    <div class="am-g">
        ...
        <div class="am-fl am-cf">
          <div class="am-btn-toolbar am-fl">
            <div class="am-btn-group am-btn-group-xs">
              <a href="<?php echo U('News/add');?>"><button type="button" class="am-btn am-btn-default"><span class="am-icon-plus"></span> 添加新闻</button></a>
            </div>
      ...
      <div class="am-u-sm-12">
        <form class="am-form">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
                <tr>
                    <th class="table-id" style="width:10%">ID</th>
                    <th class="table-title" style="width:20%">标题</th>
                    <th class="table-type" style="width:10%">封面图</th>
                    <th class="table-date" style="width:40%;text-align:center" >简介</th>
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$con): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><?php echo ($con["new_title"]); ?></td>
                <td>
                    <img src= "<?php echo (ltrim($con["new_pic"],'.')); ?>" style="width:60px;" /></td>
                <td style="text-align:center"><?php echo ($con["new_intro"]); ?></td>
              <td>
                <div class="am-btn-toolbar">
                  <div class="am-btn-group am-btn-group-xs">
                    <a href="<?php echo U('edit','id='.$con['new_id']);?>"><button type="button" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</button></a>                   
                    <a href="<?php echo U('del','id='.$con['new_id']);?>"><button type="button" class="am-btn am-btn-default am-btn-xs am-text-danger"><span class="am-icon-trash-o"></span> 删除</button></a>
                  </div>
                </div>
              </td>
