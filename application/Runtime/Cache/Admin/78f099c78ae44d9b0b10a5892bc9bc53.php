  ...
  <div class="admin-content">
    ...
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input type="hidden" name="id" value="<?php echo ($vo["new_id"]); ?>">
         ...
         <div class="am-form-group">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-name" placeholder="" value="<?php echo ($vo["new_title"]); ?>" name="new_title">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
            <img src= "<?php echo (ltrim($vo["new_pic"],'.')); ?>" style="width:80px;" />
              <input type="file" id="new_pic" name="new_pic" value="">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
            <img src= "<?php echo (ltrim($vo["new_gpic"],'.')); ?>" style="width:80px;" />
              <input type="file" id="new-gpic" name="new_gpic" >
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea  name="new_intro" id="header"  cols="30" rows="10" style="width: 600px;height: 150px"><?php echo ($vo["new_intro"]); ?></textarea>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
               <textarea  name="new_content" value="<?php echo ($vo["new_content"]); ?>" id="intro_detail" cols="30" rows="10">
                 <?php echo ($vo["new_content"]); ?>
               </textarea>
            </div>
          </div>
          ...
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              ...
              <a href="<?php echo U('News/news');?>"><button type="button" class="am-btn am-btn-primary">返回</button></a>
            </div>
