...
<!-- sidebar end -->
  ...
  <div class="admin-content">
    <div class="am-cf am-padding">
      <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">添加案例</strong> / <small>Case add</small></div>
    </div>
    <hr/>
    <div class="am-g">
      ...
      <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form class="am-form am-form-horizontal" method="post" action="<?php echo U('Cases/add');?>" enctype="multipart/form-data">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="text" id="user-name" placeholder="" name="case_title">
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea  name="header" id="header" cols="30" rows="10" style="width: 700px;resize: none;"></textarea>
          ...
          <div class="am-form-group" style="border: 1px ">
            ...
            <div class="am-u-sm-9">
              <textarea  name="footer" id="nav_footer" cols="30" rows="10"  style="width: 700px;resize: none;"></textarea>
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <input type="file" id="case_pic" name="case_pic">
            </div>
          </div>
          ...
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9">
              <textarea  name="case_content" id="intro_detail" cols="30" rows="10"></textarea>
            </div>
          </div>
          <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
              <input type="submit" class="am-btn am-btn-primary" value="保存"></button>
            </div>
          </div>
        </form>
      </div>
