    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="example-navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo U('Cases/cases');?>">案例</a></li>
...
<div class="content">
    <!--特色-->
   <div class="banner">
       <img src="/Public/Home/imgs/product/banner.png" alt="">
   </div>
    <div class="product">
        <div class="typeSize">
            <section class="row">
            <div class=" hidden-xs circle"></div>
            <div class="col-sm-offset-2 col-sm-2 text scroll-fade">
                <div>
                    <h1>01</h1>
                    <p>产品企划</p>
                </div>
            ...
            <div class="col-sm-8 img">
                <img class="scroll-right-in" src="/Public/Home/imgs/product/1@3x.png" alt="">
            </div>
        </section>
            <section class="row">
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/2@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/3@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/4@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/5@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/6@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/7@3x.png" alt="">
                </div>
            </section>
            <section class="row">
                <div class="circle hidden-xs"></div>
                <div class="col-sm-offset-2 col-sm-2 text">
                    <div>
                        <h1>08</h1>
                        <p>下一代产品升级</p>
                    </div>
                ...
                <div class="col-sm-8 img">
                    <img class="scroll-right-in" src="/Public/Home/imgs/product/8@3x.png" alt="">
                </div>
            </section>
        </div>
    </div>
...
<script type="text/javascript" src="/Public/Home/script/product.js"></script>
</html>